...
class Admin extends React.Component {
  ...
  onChangeFiles = e => {
    if (
      ...
      !confirm(
        "This will UPDATE all tickets in the system (without affecting checked in status) and remove old tickets that are not in this CSV.\n\nAre you sure you wish to continue?"
      )
    ) {
      return;
    }
      ...
      <div className="page admin">
        ...
        <Card>
          ...
          <CardText>
            {this.props.ticketCount
              ? <span>
                  ...
                  <span style={{ color: Colors.green600 }}>
                    {this.props.totalCheckedIn}
                  </span>
                  /
                  <strong>{this.props.ticketCount}</strong>
                  {" "}
            ...
            <RaisedButton
              label="Download Checked In Report"
              secondary={true}
        ...
        <Card>
          <CardTitle
            title="Manual Print"
            subtitle="Manually print a name badge"
          />
          <CardText>
            <div
              className="badge-preview"
              style={{ float: "right", width: "100%", maxWidth: "400px" }}
            >
              <canvas
